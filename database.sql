...
create table customer(name varchar(20), meter_no varchar(20),
address varchar(50), city varchar(30), state varchar(30), email varchar(40), 
phone varchar(20));
...
create table bill(meter_no varchar(20), month varchar(20), units varchar(20), totalbill varchar(20), status varchar(20));

select * from bill;

drop table bill;

delete from customer where name = 'shivam';