...
public class Project extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (msg.equals("New Customer")) {
            ...
            // exception handling is used here because notepad is an external entity, and not in in this project. So it will throw an error if notepad is not installed in the system.
            ...
            // exception handling is used here because calculator is an external entity, and not in in this project. So it will throw an error if notepad is not installed in the system.
            
            try{
                ProcessBuilder pb = new ProcessBuilder("calc.exe"); //ProcessBuilder is flexible and future-proof
                pb.start();
            } catch(Exception e){
                e.printStackTrace();
            }
